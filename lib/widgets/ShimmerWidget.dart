  ...
  Widget build(BuildContext context) {
    return AnimatedBuilder(
        ...
        builder: (BuildContext context, Widget? child) =>
            _Shimmer(child: child!, direction: widget.direction, gradient: widget.gradient, percent: _controller.value));
  }
...
class _Shimmer extends SingleChildRenderObjectWidget {
  ...
  const _Shimmer({required Widget child, required this.percent, required this.direction, required this.gradient}) : super(child: child);
